...
def lireImages():
  ...
  dicoWizard["droite"]=[]
  for i in range(3):
    dicoWizard["droite"].append(pygame.transform.scale2x(pygame.image.load("wizard_right_"+str(i)+".png").convert_alpha()))

  dicoWizard["gauche"]=[]
  for i in range(3):
    dicoWizard["gauche"].append(pygame.transform.scale2x(pygame.image.load("wizard_left_"+str(i)+".png").convert_alpha()))

  dicoWizard["repos"]=[]
  dicoWizard["repos"].append(pygame.transform.scale2x(pygame.image.load("wizard_down_0.png").convert_alpha()))
